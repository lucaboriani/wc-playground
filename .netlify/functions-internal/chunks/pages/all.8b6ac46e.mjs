/* empty css                           */import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, b as addAttribute, d as renderComponent, e as renderSlot, f as renderHead, _ as __astro_tag_component__ } from '../astro.af0e87f3.mjs';
import 'html-escaper';
...
const $$Index$3 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let posts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../../markdown/metaframeworks/what-is-a-javascript-meta-framework.md": () => import('../what-is-a-javascript-meta-framework.f9daa4cb.mjs')}), () => "../../markdown/metaframeworks/what-is-a-javascript-meta-framework.md");
  let post = posts[0];
...
const $$WebComponents = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let counter = await Astro2.glob(/* #__PURE__ */ Object.assign({"../markdown/a-counter.md": () => import('../a-counter.28631cf0.mjs')}), () => "../markdown/a-counter.md");
  let counterTxt = counter[0];
  let wcTxts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../markdown/web-components.md": () => import('../web-components.53d0a1ec.mjs')}), () => "../markdown/web-components.md");
  let wcTxt = wcTxts[0];
  let vanillaTxts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../markdown/vanilla-wc.md": () => import('../vanilla-wc.67869662.mjs')}), () => "../markdown/vanilla-wc.md");
  ...
  return renderTemplate(_a$2 || (_a$2 = __template$2(["", "\n\n\n\n<script async>\n    document.querySelector('main h1').classList.add('glitched')\n    Array.from(document.querySelectorAll('main h2'))\n    .forEach(h2 => {\n        h2.classList.add('glitched')\n    })\n<\/script>"])), renderComponent($$result, "Layout", $$Layout, { "title": "Web Components", "class": "astro-LSJJWIS5" }, { "aside": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<aside class="aside astro-LSJJWIS5">
        <ul class="sticky top-20 astro-LSJJWIS5">
            ${renderComponent($$result2, "LitNavigation", $$LitNavigation, { "class": "astro-LSJJWIS5" }, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "Tab", $$Tab, { "class": "astro-LSJJWIS5" }, { "default": ($$result4) => renderTemplate`<h3 class="astro-LSJJWIS5">... The nth counter</h3><p class="astro-LSJJWIS5">A "beautifully" styled Web component example</p><p class="instructions astro-LSJJWIS5">
                        ${renderComponent($$result4, "my-counter", "my-counter", { "class": "astro-LSJJWIS5" })}
                        
                    </p>` })}${renderComponent($$result3, "Tab", $$Tab, { "class": "astro-LSJJWIS5" }, { "default": ($$result4) => renderTemplate`<h3 class="astro-LSJJWIS5">
                    ...
                    </h3>${renderComponent($$result4, "custom-button", "custom-button", { "title": "a styled button", "class": "astro-LSJJWIS5" })}` })}${renderComponent($$result3, "Tab", $$Tab, { "class": "astro-LSJJWIS5" }, { "default": ($$result4) => renderTemplate`<h3 class="astro-LSJJWIS5">Expanding List example</h3><p class="instructions astro-LSJJWIS5">
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const posts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../../markdown/testing/component-test.md": () => import('../component-test.662c6321.mjs'),"../../markdown/testing/concepts.md": () => import('../concepts.2128db27.mjs'),"../../markdown/testing/end-to-end.md": () => import('../end-to-end.ebfd6007.mjs'),"../../markdown/testing/intro-to-cypress.md": () => import('../intro-to-cypress.d20000d7.mjs'),"../../markdown/testing/intro.md": () => import('../intro.116f7491.mjs'),"../../markdown/testing/testing-react-components-cypress.md": () => import('../testing-react-components-cypress.0b1ee4ce.mjs'),"../../markdown/testing/testing-react-components-react-testing-library.md": () => import('../testing-react-components-react-testing-library.3ad311e1.mjs'),"../../markdown/testing/testing-vue-components-cypress.md": () => import('../testing-vue-components-cypress.fdcb1608.mjs'),"../../markdown/testing/testing-vue-components-vue-testing-library.md": () => import('../testing-vue-components-vue-testing-library.19cd1ea6.mjs'),"../../markdown/testing/types-of-testing.md": () => import('../types-of-testing.68a88ad7.mjs'),"../../markdown/testing/unit-testing-with-jest.md": () => import('../unit-testing-with-jest.a980a1a7.mjs')}), () => "../../markdown/testing/*.md");
...
const $$SplittedTasksSsrReact = createComponent(async ($$result, $$props, $$slots) => {
  ...
  console.log(url);
  console.log("env");
  console.log((Object.assign({"PUBLIC_API_BASE":"http://localhost:3000/api","BASE_URL":"/","MODE":"production","DEV":false,"PROD":true,"SSR":true,"SITE":undefined},{})));
  url += ":3000";
  try {
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  let posts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../../markdown/lit.md": () => import('../lit.fc08473e.mjs')}), () => "../../markdown/lit.md");
  let post = posts[0];
  let markdownUseless = await Astro2.glob(/* #__PURE__ */ Object.assign({"../../markdown/useless-button.md": () => import('../useless-button.284822f1.mjs')}), () => "../../markdown/useless-button.md");
...
const $$LitReact = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let posts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../../markdown/lit-react.md": () => import('../lit-react.551308c6.mjs')}), () => "../../markdown/lit-react.md");
  let post = posts[0];
...
const $$LitVue = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$LitVue;
  let posts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../../markdown/lit-vue.md": () => import('../lit-vue.b9d2e299.mjs')}), () => "../../markdown/lit-vue.md");
  let post = posts[0];
